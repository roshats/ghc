...
tcFamDecl1 parent
  ...
  ; let tycon = buildFamilyTyCon tc_name tvs' OpenSynFamilyTyCon kind parent
  ; return [ATyCon tycon] }
...
-- of both the type family and the equations for a CoAxiom.
  = do { traceTc "closed type family:" (ppr tc_name)
       ...
       ; case mb_eqns of
           Nothing   -> do { let tycon = buildFamilyTyCon tc_name tvs'
       ...
       ; let tycon = buildFamilyTyCon tc_name tvs'
